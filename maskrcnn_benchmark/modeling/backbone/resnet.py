...
from maskrcnn_benchmark.modeling.backbone.bn import InPlaceABNSync as BatchNorm2d
...
_TRANSFORMATION_MODULES = Registry({
    ...
    "BottleneckWithSyncBatchNorm": BottleneckWithSyncBatchNorm,
})

_STEM_MODULES = Registry({
    "StemWithFixedBatchNorm": StemWithFixedBatchNorm,
    "StemWithGN": StemWithGN,
    "StemWithSyncBatchNorm": StemWithSyncBatchNorm,
})
