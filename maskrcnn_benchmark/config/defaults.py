...
_C.MODEL.SEG_ON_ADD_CHANEL = False
...
_C.MODEL.FPN.ONLY_P6 = False
_C.MODEL.FPN.USE_P6P7 = True

_C.MODEL.FPN.ATT_DENSE = False # ATT_DENSE is prior to DENSE
_C.MODEL.FPN.DENSE = False
...
_C.MODEL.ROI_MASK_HEAD.POOLER_RESOLUTION = (14,) #(32,16,8,4,4) #
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = 2 # 81
_C.MODEL.FCOS.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.MODEL.FCOS.PRIOR_PROB = 0.01
_C.MODEL.FCOS.INFERENCE_TH = 0.05
_C.MODEL.FCOS.TRAIN_PRE_NMS_TH = 0.05
_C.MODEL.FCOS.NMS_TH = 0.6
_C.MODEL.FCOS.PRE_NMS_TOP_N = 1000
_C.MODEL.FCOS.POST_NMS_TOP_N_TRAIN = 100  # used for mask head
_C.MODEL.FCOS.POST_NMS_TOP_N_TEST = 100
# Focal loss parameter: alpha
_C.MODEL.FCOS.LOSS_ALPHA = 0.25
# Focal loss parameter: gamma
_C.MODEL.FCOS.LOSS_GAMMA = 2.0
_C.MODEL.FCOS.CENTER_WEIGHT = 1.0

# the number of convolutions used in the cls and bbox tower
_C.MODEL.FCOS.NUM_CONVS = 4
_C.MODEL.FCOS.EVAL_HEAD = False
# ---------------------------------------------------------------------------- #
...
_C.SOLVER.CHECKPOINT_SAVE_PATH = "./"
